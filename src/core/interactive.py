...
from AutoInterp.src.core.utils import PACKAGE_ROOT, load_persona
...
async def make_revision_call(
    ...
    *stage_key* selects the revision prompt from ``prompts/interactive.yaml``
    ...
    # Prepend persona if defined for interactive prompts
    persona = load_persona("interactive.yaml")
    if persona:
